				...
				foreach ($arrayRel as $value) {
					...
					foreach ($imagesArray as $featuredImg) {
						if(empty($featuredImg["featured_image"])){
							...
							$output .= '<div style="position:absolute;bottom:0;height:80px;top:34px;width:100%;">';
							$output .= '	<h5 class="peopleText" style="font-weight: 600; color: rgb(0, 143, 180); margin: 12px 20px 0px; font-size: 14px; text-transform: capitalize; display: block;">' . $client. '</h5>';
							$output .= '	<h6 class="peopleText" style="color: rgb(0, 143, 180); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display:block; text-transform: capitalize; font-weight: 200; text-overflow: ellipsis;">' . $title . '</h6>';
							$output .= '</div>';
							if($readMore == 1){
								$output .= '<div class="peopleText" style="position: absolute; left: 20px; bottom: 13px; color: rgb(0, 143, 180); font-size: 12px; text-transform: capitalize; display: block; font-family: museo-sans, sans-serif; font-weight: 300;">Read more...</div>';			
							}
							$output .= '</div>';
							if($readMore == 1){
								$output .= '</a>';
							...
							$output .= '<div class="projectHoverImg profile-box" style="position:relative;float:left;background:url(' . $featuredImg["featured_image"] . ') 50% 50% no-repeat;overflow:hidden; background-size:cover;'; 
							if($readMore == 1){
								$output .= 'cursor:pointer;';
							}; 
							$output .= '">';
							...
							$output .= '		<h6 class="peopleText" style="color: rgb(255, 255, 255); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display: none; text-transform: capitalize; font-weight: 200; text-overflow: ellipsis;">' . $title . '</h6>';
							$output .= '</div>';
							if($readMore == 1){
								$output .= '<div class="peopleText" style="position: absolute; left: 20px; bottom: 13px; color: rgb(255, 255, 255); font-size: 12px; text-transform: capitalize; display: none; font-family: museo-sans, sans-serif; font-weight: 300;">Read more...</div>';
							}
							$output .= '</div>';
							if($readMore == 1){
								$output .= '</a>';
...
function custom_services_section_function(){
	...
	$output .= '<div class="heroText">' . the_content() .'</div>';
        if( get_field('aoe') ){
		...
		$output .= '<div class="services-image-block">';
			...
			foreach ($arrayRel as $value) {
				...
				if(empty($imagesArray[0]["featured_image"])){
					...
					$output .= '">';
			        $output .= '<div style="opacity: 0.8; position: absolute; bottom: 0px; height: 100%; width: 100%; display: none; background-color: rgb(37, 82, 128);" class="profile-box-highlight"></div>';
					$output .= '<div style="position:absolute;bottom:0;height:80px;top:46px;width:100%;">';
						$output .= '<h5 class="peopleText" style="font-weight: 600; color: rgb(0, 143, 180); margin: 12px 20px 0px; font-size: 14px; display: block;">' . $client . '</h5>';
						$output .= '<h6 class="peopleText" style="color: rgb(0, 143, 180); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display:block; font-weight: 200; text-overflow: ellipsis;">' . $title . '</h6>';
					$output .= '</div>';  
					if($readMore == 1){
						$output .= '<div class="peopleText" style="position: absolute; left: 20px; bottom: 13px; color: rgb(0, 143, 180); font-size: 12px; display: block; font-family: museo-sans, sans-serif; font-weight: 300;">Read more...</div>';
					}	
					$output .= '</div>';
					if($readMore == 1){
						$output .= '</a>';
					...
					foreach ($imagesArray as $featuredImg) {
						...
						$output .= 'background:url(' . $featuredImg["featured_image"] . ') 50% 50% no-repeat;overflow:hidden; background-size:cover;">';
					}
					$output .= '<div style="opacity: 0.8; position: absolute; bottom: 0px; height: 100%; width: 100%; display: none; background-color: rgb(37, 82, 128);" class="profile-box-highlight"></div>';
					$output .= '<div style="position:absolute;bottom:0;height:80px;top:46px;width:100%;">';
					...
					$output .= '<h6 class="peopleText" style="color: rgb(255, 255, 255); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display: none; font-weight: 200; text-overflow: ellipsis;">' . $title . '</h6>';
					$output .= '</div>';
					$readMore = get_field('read_more', $projectID);
					if($readMore == 1){
						$output .= '<div class="peopleText" style="position: absolute; left: 20px; bottom: 13px; color: rgb(255, 255, 255); font-size: 12px; display: none; font-family: museo-sans, sans-serif; font-weight: 300;">Read more...</div>';
				...
				$featured_image = get_sub_field('featured_image'); 
		   		$readMore = get_field('read_more', $related_project->ID); 
					...
					if(empty($featured_image)){
						...
						$output .= 'float:left;overflow:hidden; margin-left:30px;margin-bottom:30px;background-color:rgba(191, 204, 215, 0.4);">';

						$output .= '<div style="opacity: 0.8; position: absolute; bottom: 0px; height: 100%; width:100%; display: none; background-color: rgb(37, 82, 128);" class="profile-box-highlight"></div>';
							$output .= '<div style="position:absolute;height:80px;top:30px;width:100%;">';
								$output .= '<h5 class="peopleText" style="font-weight: 600; color: rgb(0, 143, 180); margin: 0px 20px 0px 20px; font-size: 14px; text-transform: capitalize; display: block;">' . get_field('client',$related_project->ID) . '</h5>';
								$output .= '<h6 class="peopleText" style="color: rgb(0, 143, 180); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display: block; font-weight: 200;text-overflow: ellipsis;">' . get_the_title($related_project->ID) . '</h6>';
						$output .= '</div>';	
						...
						if($readMore == 1){
							...
							$output .= 'float:left;background:url(' . $featured_image . ') 50% 50% no-repeat;overflow:hidden; background-size:cover;">';
						...
						$output .= '<div style="opacity: 0.8; position: absolute; bottom: 0px; height: 100%; width:100%; display: none; background-color: rgb(37, 82, 128);" class="profile-box-highlight"></div>';
							$output .= '<div style="position:absolute;height:80px;top:30px;width:100%;">';
								...
								$output .= '<h6 class="peopleText" style="color: rgb(255, 255, 255); margin: 0px 0px 0px 20px; font-size: 13px; letter-spacing: 0.5px; min-height: 80px; padding-right: 10px; display: none; font-weight: 200;text-overflow: ellipsis;">' . get_the_title($related_project->ID) . '</h6>';					
							$output .= '</div>';
...
function custom_people_section_function(){
	$output = '';
	$output .= '<div style="margin:0 auto;width:100%;position:relative;padding:15px 0;">';
				...
				$output .= '<ul class="people-list">';
					...
					$output .= '<li>';
						...
						$output .= '<div id="' . get_the_ID() . '" class="profile-box';
						 ...
						 $output .= '<div style="position:absolute;bottom:0;top:30px;width:100%;">';
						 $output .= '	<h5 class="open-sans peopleText" style="font-weight:700;'; 						 						 if(empty($photo)){
							 $output .= 'color: rgb(0, 143, 180);';
						 }else{
		                 ...
		                 $output .= '<div class="peopleText" style="padding:20px;bottom:13px;font-size:12px;font-family: museo-sans, sans-serif;font-weight:300;';
						 if(empty($photo)){
							 $output .= 'color: rgb(0, 143, 180);';
						 }else{
							 $output .= 'display:none;color:#fff;';
						 ...
						 $output .= '">';
							 ...
							 $output .= '</div>';
						 $output .= '</div>';
						 $output .= '<div class="peopleText read-more" style="font-weight:300;position:absolute;padding:0 20px;bottom:13px;font-size:12px;font-family: museo-sans, sans-serif; font-weight: 300;';
		 				 if(empty($photo)){
							 $output .= 'color: rgb(0, 143, 180);';
						 }else{
							 $output .= 'display:none;color:#fff;';
...
function custom_project_blocks_function() {
	...
	if ( $projects->have_posts() ) : while ( $projects->have_posts() ) : $projects->the_post(); 
		...
		$output .= '<div class="fpb-box fpbNoImageBox">';
		$output .= '	<div class="fpb-shade fpbNoImageShade"></div>';
		$output .= '	<div class="fpb-highlight fpbNoImageHighlight"></div>';
        $output .= '   <div class="fpb-text fpbNoImageText">';
            ...
            //apply preferred heading style
            if(empty($heading_style)){
                $output .= '<h5 class="fpb-header">' . $hoverTitle . '</h5>';
            }else{
                $output .= '<' . $heading_style . ' class="fpb-header">' . $hoverTitle . '</' . $heading_style . '>';
            }
            if(empty($text_style)){
                $output .= '<h6 class="fpb-subline">' . $hoverText. ' &nbsp;</h6>';
            }else{
                $output .= '<' . $text_style . ' class="fpb-subline">' . $hoverText. ' &nbsp;</' . $text_style . '>';
            }
            ...
            $output .= '</div>';
							...
							if(1==1){//left here in case it is to be reused
								$output .= '<div class="fpb-readMore fpbNoImageReadMore" style="position: absolute; left: 25px; bottom: 13px; font-size: 14px; text-transform: capitalize; display: block; font-family: museo-sans, sans-serif; font-weight: 300; color:#fff; display:none;">Read more...</div>';
		...
		$permalink = get_permalink($post->ID);			
		$output .= '<li><a href="' . $permalink . '"><div class="fpb-box" style="background-image:url('.  $featured_image . ');">';
        $output .= '<div class="fpb-shade"></div>';
        $output .= '<div class="fpb-highlight"></div>';
        $output .= '    <div class="fpb-text"> ';   
		...
		$output .= '</div>';
						...
						$readMore = get_field('read_more');
							...
							$output .= '<div class="fpb-readMore" style="position: absolute; left: 25px; bottom: 13px; font-size: 14px; text-transform: capitalize; display: block; font-family: museo-sans, sans-serif; font-weight: 300; display:none; color:#fff;">Read more...</div>';
							}
		$i++;				
		$output .= '</div>';
        $output .= '</a></li>';			
    ...
    $output .= '</a></li>';
		...
		$permalink = get_permalink($post->ID);
		$output .= '<li><a href="' . $permalink . '"><div class="fpb-box" style="background-size:cover; background-image:url(' .  $featured_image . ');">';	
		$output .= '<div class="fpb-shade"></div>';
		$output .= '<div class="fpb-highlight"></div>';
		$output .= '	<div class="fpb-text">';
					$heading_style = get_field('home_page_hover_title_style_people');
			...
			$output .= '</div>';
                    ...
                    if(1==1){//left here in case it is to be reused
                    $output .= '<div class="fpb-readMore" style="position: absolute; left: 25px; bottom: 13px; font-size: 14px; text-transform: capitalize; display: block; font-family: museo-sans, sans-serif; font-weight: 300; color:#fff; display:none;">Read more...</div>';
