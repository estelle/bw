...
class TextAndIcon_field extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function __construct($parent)
	{
    	...
    	// set name / title
    	$this->name = 'text_and_icon'; // variable name (no spaces / special characters / etc)
		$this->title = __("Text and Icon",'acf'); // field label (Displayed in edit screens)
